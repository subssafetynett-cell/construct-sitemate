                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 3, opacity: saving ? 0.35 : 1 }}>
                    <Box>
                        ...
                        <TextField
                            ...
                            sx={{ mb: existingId || showVisibilityChoice ? 2 : 0 }}
                        />
                        {existingId || showVisibilityChoice ? (
                            <TextField
                                fullWidth
                                label="Tags"
                            ...
                            <>
                                ...
                                <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
                                    ...
                                    >
                                        ...
                                        <Typography variant="caption" color="text.secondary">
                                            Update the current form record
                                        </Typography>
                                    </Paper>
                                    ...
                                    >
                                        ...
                                        <Typography variant="caption" color="text.secondary">
                                            Save as a separate new form
                                        </Typography>
                                    </Paper>
                                </Box>
                            </>
                        ) : (
                            <Typography variant="body2" sx={{ fontWeight: 500, color: isDarkMode ? "#9CA3AF" : "#6B7280" }}>
                                {isSitePackContext
                                    ? "Enter a form name, then save. It will appear in your Friday Pack folder."
                                    : templateFlow
                                      ? "Enter a form name, then save."
                                      : "Enter a form name to save this form."}
                            </Typography>
                        )}
                    </Box>
                </Box>
